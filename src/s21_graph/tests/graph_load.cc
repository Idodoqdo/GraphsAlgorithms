...
TEST(graph, constructor_from_file_fail_1) {
  EXPECT_ANY_THROW(
      s21::Graph graph(CMAKE_CURRENT_SOURCE_DIR "/graph_raw_file_broken1"));
}

TEST(graph, constructor_from_file_fail_2) {
  EXPECT_ANY_THROW(
      s21::Graph graph(CMAKE_CURRENT_SOURCE_DIR "/graph_raw_file_broken2"));
}

TEST(graph, constructor_from_file_fail_3) {
  EXPECT_ANY_THROW(
      s21::Graph graph(CMAKE_CURRENT_SOURCE_DIR "/graph_raw_file_broken3"));
}

TEST(graph, constructor_from_file_fail_4) {
  EXPECT_ANY_THROW(
      s21::Graph graph(CMAKE_CURRENT_SOURCE_DIR "/graph_raw_file_broken4"));
}

TEST(graph, constructor_from_file_fail_5) {
  EXPECT_ANY_THROW(
      s21::Graph graph(CMAKE_CURRENT_SOURCE_DIR "/graph_raw_file_broken5"));
}
